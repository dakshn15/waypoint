            ...
            <Card className="glass-card">
              <CardContent className="p-6 space-y-6">
                <h3 className="text-xl font-bold flex items-center gap-2">
                  <MessageSquare className="h-5 w-5 text-[var(--waypoint-teal)]" />
                  Contact Info
                </h3>
                ...
                <div className="space-y-4 text-sm">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <a href="mailto:support@waypoint.dev" className="text-[var(--waypoint-teal)] hover:underline">
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <span className="text-muted-foreground">DLF CyberCity, Phase 3, Gurugram, HR, India</span>
                    </div>
                  </div>
                </div>
              </CardContent>
          ...
          <div className="md:col-span-3">
            <Card className="glass-card border border-zinc-200 dark:border-zinc-800">
              <CardHeader>
                ...
                <CardDescription>Fill out this form and our support agents will coordinate with you.</CardDescription>
              </CardHeader>
              <CardContent>
                <form onSubmit={handleSubmit} className="space-y-4">
                  ...
                  <Button
                    type="submit"
                    disabled={submitting}
                    className="w-full bg-[var(--waypoint-navy)] hover:bg-[var(--waypoint-teal)] text-white gap-2"
                  >
